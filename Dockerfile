...
RUN apt-get install -y supervisor vim-tiny iputils-ping tmux bsdmainutils
WORKDIR /root
RUN wget --no-check-certificate  \
    https://github.com/xmrig/xmrig-proxy/releases/download/v2.6.5/xmrig-proxy-2.6.5-xenial-amd64.tar.gz \
